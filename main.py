...
async def button_info_callback(update: Update, context: CallbackContext):
...
def handle_response(text: str) -> str:
    ...
    if 'quiero informacion de los precios' in processed:
        return 'Ingresa a los catalogos de los productos iniciando con: /producto, /producto2, /producto3, /producto4, /producto5 para ver los menus'
...
async def producto_command(update, context):
    ...
    products = [
        {"name": "Criollos Panecitos", "price": "Q25",
         "image_url": "https://img-global.cpcdn.com/recipes/09ed2d0c0b52fd84/640x640sq70/photo.webp"},
        {"name": "Combo de pastelitos de crema", "price": "Q40",
         "image_url": "http://blog.cosasderegalo.com/wp-content/uploads/2013/05/pastelitos-merengue-menu-recetas.jpg"},
        {"name": "Tazon de empanadas", "price": "Q35",
         "image_url": "https://quierocakes.com/wp-content/uploads/2019/02/pastelitos.jpg"},
        {"name": "Pastelitos Venezolanos", "price": "Q20",
         "image_url": "https://comidasvenezolanas.org/wp-content/uploads/2021/02/pastelitos-venezolanos_700x466.jpg"},
        {"name": "Empanadas de pollo", "price": "Q20",
         "image_url": "https://d1kxxrc2vqy8oa.cloudfront.net/wp-content/uploads/2019/11/02125135/RFB-3110-3-masadepastelitos.jpg"},
        {"name": "Calzones de jamon y queso", "price": "Q15",
         "image_url": "https://comidahonduras.com/wp-content/uploads/2022/07/pastelitos-jamon-queso-Comidahonduras-800x530.jpg"},
        {"name": "Pastelito de chocolate", "price": "Q10",
         "image_url": "https://4.bp.blogspot.com/-MbyGZ4b22B0/VMB_NHUM66I/AAAAAAAACFY/qIzy5YGJCP8/s1600/Chocolate%2BCupcakes%2BSyS2.jpg"},
        {"name": "Pastelitos Andinos", "price": "Q40",
         "image_url": "https://comidasvenezolanas.org/wp-content/uploads/2021/01/pastelitos-andinos_700x466.jpg"},
        {"name": "Pan con pollo", "price": "Q25",
         "image_url": "https://www.recetassalvador.com/base/stock/Recipe/38-image/38-image_web.jpg"},
        {"name": "Pan con chile", "price": "Q28",
         "image_url": "https://media-cdn.tripadvisor.com/media/photo-s/0f/91/da/a5/pan-con-chile-relleno.jpg"}
    ]
...
async def producto2_command(update, context):
    ...
    products = [
        {"name": "Pastel de fresas con crema", "price": "Q100",
         "image_url": "https://storage.googleapis.com/patsy-ecommerce.appspot.com/small_FRESAS_CON_CREMA_6bb4f36558"},
        {"name": "Pastel selva negra", "price": "Q130",
         "image_url": "https://storage.googleapis.com/patsy-ecommerce.appspot.com/small_SELVA_NEGRA_1964333182"},
        {"name": "Pie de queso y piña colada", "price": "Q135",
         "image_url": "https://storage.googleapis.com/patsy-ecommerce.appspot.com/small_3_ab13793c36"},
        {"name": "Pie de queso mango y piña", "price": "Q120",
         "image_url": "https://storage.googleapis.com/patsy-ecommerce.appspot.com/small_1_330dc2313f"},
        {"name": "Pie de queso, frambuesa y chocolate blanco", "price": "Q120",
         "image_url": "https://storage.googleapis.com/patsy-ecommerce.appspot.com/small_4_14cec30bc0"},
        {"name": "Pie de queso y mermelada berries", "price": "Q150",
         "image_url": "https://storage.googleapis.com/patsy-ecommerce.appspot.com/small_2_027b972668"},
        {"name": "Pastel fresa melocotón", "price": "Q140",
         "image_url": "https://storage.googleapis.com/patsy-ecommerce.appspot.com/small_FRESA_MELO_2a4a35bccc"},
        {"name": "Pastel chocolate con frutas", "price": "Q240",
         "image_url": "https://storage.googleapis.com/patsy-ecommerce.appspot.com/small_PASTEL_CHOCOLATE_CON_FRUTAS_7a7aa83fc0"},
        {"name": "Pastel brownie y cajeta", "price": "Q250",
         "image_url": "https://storage.googleapis.com/patsy-ecommerce.appspot.com/small_BROWNIE_CAJETA_6214f268a4"},
        {"name": "Pastel chocoflan", "price": "Q200",
         "image_url": "https://storage.googleapis.com/patsy-ecommerce.appspot.com/PASTEL_CHOCOFLAN_copia_f2b4acfd3b"}
    ]
...
if __name__ == '__main__':
    ...
    app.add_handler(CallbackQueryHandler(button_info_callback, pattern='info'))
    #
    app.add_handler(CallbackQueryHandler(button_info_callback, pattern='info2'))
